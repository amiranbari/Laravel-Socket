...
e.channel('laravel_database_presence-user').listen('.message.created', function (e) {
  $('#main-messages').prepend("\n        <div class=\"alert alert-secondary\" role=\"alert\">\n                    <span class=\"message\">".concat(e.data.message, "</span>\n                    <div class=\"profile\">\n                        ").concat(e.data.user, "\n                    </div>\n                </div>\n        "));
});
e.join('user').here(function (users) {
  users.forEach(function (user) {
    $('#online-users').prepend("<li id=\"user-".concat(user.id, "\">").concat(user.name, "</li>"));
  });
